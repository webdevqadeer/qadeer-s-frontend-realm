        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            <div className="space-y-4">
              <p className="text-primary font-medium animate-fade-in-up">
                Hello, I'm
              </p>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground animate-fade-in-up delay-100">
                Abdul Qadeer
              </h1>
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold gradient-text animate-fade-in-up delay-200">
                Frontend Developer
              </h2>
            </div>
            
            <p className="text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0 animate-fade-in-up delay-300">
          ...
          <div className="flex justify-center order-1 lg:order-2 animate-scale-in">
            <div className="relative">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-8 h-8 rounded-full gradient-bg animate-pulse-glow" />
              <div className="absolute -bottom-2 -left-6 w-6 h-6 rounded-full bg-blue-300 animate-pulse" />
            </div>
          </div>
        </div>
      </div>
